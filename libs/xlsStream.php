...
function export_file(&$assoc, $file_name)
{
    $arr = explode('.', $_SERVER['SERVER_NAME']);
    $file_name = $arr[1] . '_' . $file_name;
    $export_file = "xlsfile://tmp/{$file_name}.xls";
    //  $export_file = "xlsfile://{$file_name}.xls";
