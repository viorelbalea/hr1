<div class="submeniu">
    ...
    {if $smarty.session.USER_ID == 1 || $smarty.session.ACCESSSURVEY == 2 ||  $smarty.session.ACCESSSURVEY == 3}
        <a href="./?m=surveys&o=evalPersonsEvaluator" class="selected">{translate label='Studii angajati'}</a>
    {/if}
    {if $smarty.session.USER_ID != 1 || $smarty.session.ACCESSSURVEY == 2 ||  $smarty.session.ACCESSSURVEY == 3}
...
<div class="filter">
    ...
    <select id="DistrictID" name="DistrictID"
            onchange="if (this.value>0) window.location.href = './?m=surveys&o=evalPersonsEvaluator&DivisionID=' + document.getElementById('DivisionID').value + '&DistrictID=' + this.value"
            class="cod">
    ...
    {if !empty($divisions)}
        <select id="DivisionID" name="DivisionID"
                onchange="window.location.href = './?m=surveys&o=evalPersonsEvaluator&DistrictID=' + document.getElementById('DistrictID').value + '&DivisionID=' + this.value"
                class="dropdown">
    ...
    <input type="checkbox"
           onclick="if (this.checked) window.location.href = './?m=surveys&o=evalPersonsEvaluator&Status=2'; else window.location.href = './?m=surveys&o=evalPersonsEvaluator';"
    ...
    {foreach from=$persons key=key item=item name=iter1}
        {if $key>0}
            <tr height="30">
                ...
                <td class="celulaMenuST"><a href="./?m=surveys&o=forms-evaluator&PersonID={$item.PersonID}"
