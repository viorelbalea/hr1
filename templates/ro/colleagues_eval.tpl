<div class="submeniu">
    {if $smarty.session.USER_ID == 1 || $smarty.session.ACCESSCEVAL == 1 || $smarty.session.ACCESSCEVAL == 3}
        ...
        <a href="./?m=colleagues-eval&o=evalDraft&action=new" class="unselected">{translate label='Adauga formular evaluare'}</a>
    ...
    {if $smarty.session.USER_ID == 1 || $smarty.session.ACCESSCEVAL == 2 ||  $smarty.session.ACCESSCEVAL == 3}
        <a href="./?m=colleagues-eval&o=evalPersonsEvaluator" class="unselected">{translate label='Evaluari angajati'}</a>
    {/if}
    {if $smarty.session.USER_ID != 1 || $smarty.session.ACCESSCEVAL == 2 ||  $smarty.session.ACCESSCEVAL == 3}
            ...
            <td colspan="2" class="celulaMenuSTDR" style="padding: 10px;">
                <fieldset>
                    ...
                    <table cellspacing="0" cellpadding="4">
                        ...
                        <tr>
                            <td colspan="3">
                                {if ($smarty.session.PersonID==$evalEvaluatorID && $Completed==0) && ($smarty.session.ACCESSCEVAL == 2 || $smarty.session.ACCESSCEVAL == 3)}
