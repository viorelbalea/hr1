...
<form action="./?m=admin&o=import_salary" method="post" enctype="multipart/form-data" name="upload_pers">
                ...
                <tr height="30">
                    <td style="text-align:center;" colspan="100" class="celulaMenuSTDR">
                        <b>{translate label='Va rugam incarcati un fisier format .xls impreuna cu capetele de tabel.'} <br/>
                            <br/>{translate label=' Coloanele trebuie sa fie in ordine: Marca/ CNP/ Salariu brut/ Data inceput (ll/zz/aaaa)'}
