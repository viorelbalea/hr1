...
{if !isset($smarty.get.print)}{include file="functions_menu.tpl"}<br/>
    <div style="float:left">
        <fieldset>
            <legend>{translate label='Organigrama directii si servicii'}</legend>
            <table cellspacing="0" cellpadding="0" width="100%" border="0" class="filter">
                ...
                <tr height="40">
                    ...
                    <td style="padding-left: 2px;" width="70"><select id="Level" name="Level" class="dropdown" style="width:120px;"
                                                                      onchange="window.location.href = './?m=functions&o=organigram_dir&CompanyID=' + document.getElementById('CompanyID').value + '&mark={$smarty.get.mark}&mark2={$smarty.get.mark2}&mark3={$smarty.get.mark3}&Level=' + document.getElementById('Level').value">
...
<div style="float:left; width:50%;">
    <fieldset>
        <legend>{translate label='Organigrama'}</legend>
        <a id="showHorizontal" class="selected" href="#">{translate label='Organigrama orizontala'}</a>
        [<a href="?m=functions&o=organigram_dir&CompanyID={$smarty.get.CompanyID}&mark={$smarty.get.mark}&mark2={$smarty.get.mark2}&mark3={$smarty.get.mark3}&Level={$smarty.get.Level}&print=1">print</a>]
        &nbsp;&nbsp;|&nbsp;&nbsp;
        <a id="showVertical" href="#">{translate label='Organigrama verticala'}</a>
        [<a href="?m=functions&o=organigram_dir&CompanyID={$smarty.get.CompanyID}&mark={$smarty.get.mark}&mark2={$smarty.get.mark2}&mark3={$smarty.get.mark3}&Level={$smarty.get.Level}&print=2">print</a>]
        <br/>
