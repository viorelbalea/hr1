{if !empty($smarty.get.PersonID)}
    <div style="width:800px; margin:0px;">
        ...
        <div style="width:100%; margin:0px;  line-height:150%;">
            ...
            <p style="text-indent:40px; text-align:justify; margin:0px;">
                Avand in vedere motivul in fapt al incetarii si comunicarea de catre {if $info.Sex == 'M'}Domnul{else}Doamna{/if} {$info.FullName}
                a deciziei de pensie nr. {$info.ResignationDemandNo|default:'.........'} / {$info.StopDate|date_format:'%d.%m.%Y'|default:'....................'} privind acordarea
                pensiei pentru limita de varsta / anticipata / anticipata partial / invaliditate;
            </p>
            <p style="text-indent:40px; text-align:justify; margin:0px;">
            ...
            <p style="text-indent:40px; text-align:justify; margin:0px;">
                <b>Art. 1.</b> Contractul de munca al {if $info.Sex == 'M'}Domnului{else}Doamnei{/if} {$info.FullName}, meseria
                (functia) {$info.Function|default:'...........................'}
                la {$info.CompanyName|default:'.....................'} inceteaza de drept incepand cu data de {$info.StopDate|date_format:'%d.%m.%Y'|default:'....................'}
                conform <b>art. 56 (1) lit. c) </b> din Codul Muncii.
            </p>
            <p style="text-indent:40px; text-align:justify; margin:0px;">
