...
<table border="0" cellpadding="4" cellspacing="0" class="screen" width="100%">
    <tr>
        <td colspan="2" valign="top" class="bkdTitleMenu"><span class="TitleBox">{translate label='Alegere meniu'}</span></td>
    </tr>
    <tr valign="top">
        <td class="celulaMenuST" style="vertical-align: top; padding-left: 10px; padding-bottom: 10px;" colspan="2">
            <br>
            <fieldset>
                <legend>{translate label='Alegere meniu'}</legend>
                ...
                <input type="button" value="{translate label='Alege'}"
                       onclick="window.location.href = './?m=catering&o=choosemenu&StartDate=' + document.getElementById('StartDate').value + '&EndDate=' + document.getElementById('EndDate').value">
                <br><br>
                {if $smarty.get.msg==1}
    ...
    <tr>
        <td colspan="2" valign="top" class="bkdTitleMenu"><span class="TitleBoxDown">{translate label='alegere meniu'}</span></td>
    </tr>
</table>