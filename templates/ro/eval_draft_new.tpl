<div class="submeniu">
    ...
    {if $smarty.session.USER_ID == 1 || $smarty.session.ACCESSEVAL == 1 || $smarty.session.ACCESSEVAL == 3}
        ...
        <a href="./?m=eval&o=evalDraft&action=new" class="selected">{translate label='Adauga formular evaluare'}</a>
...
<table border="0" cellpadding="4" cellspacing="0" class="screen" width="100%">
    ...
    {if $smarty.get.action=='edit'}
        <tr>
            <td colspan="2" align="right" style="padding-right: 4px;" width="300">
                <input type="button" onclick="window.location.href = '{$smarty.server.REQUEST_URI}&export_doc=1'"
                       value="Export .doc">
            </td>
        </tr>
    {/if}
            ...
            <form action="{$request_uri}" method="post">
                <fieldset>
                    ...
                    <table border="0" cellpadding="4" cellspacing="0">
                        ...
                        <tr>
                            <td><b>{translate label='Cod formular'}</b></td>
                            <td>
                                <input type="text" id="FormCode" name="FormCode" value="{$form.FormCode}" size="50"
                                       maxlength="200">
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td><b>{translate label='Descriere formular'}</b></td>
                            <td colspan="2">
                                <textarea id="FormDesc" name="FormDesc" style="width:440px;">{$form.FormDesc}</textarea>
                            </td>
                    </table>
                </fieldset>
            </form>
                        ...
                        <table border="0" cellpadding="4" cellspacing="0" class="screen" width="600">
                            ...
                            {foreach from=$sections item=item}
                                ...
                                {foreach from=$item.Questions item=item2 key=key2 name=name2}
                                    <form
                                            action="?m=eval&o=evalDraft&EvalFormDraftID={$item.EvalFormDraftID}&action=edit_question&EvalQuestionID={$item2.EvalQuestionID}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div id="button_del"><a href="#"
                                                                        onclick="if (confirm('Sunteti sigura(a)?')) window.location.href = './?m=eval&o=evalDraft&EvalFormDraftID={$item.EvalFormDraftID}&EvalQuestionID={$item2.EvalQuestionID}&action=del_question'; return false;"
                                ...
                                <form
                                        action="?m=eval&o=evalDraft&EvalFormDraftID={$smarty.get.EvalFormDraftID}&action=edit_question&EvalQuestionID=0"
            ...
            <fieldset>
                ...
                <table width="700" border="0" cellpadding="4" cellspacing="0">
                    <tr>
                        ...
                        <td class="bkdTitleMenu"><span class="TitleBox">{translate label='Numar evaluari'}</span></td>
                        <td class="bkdTitleMenu"><span class="TitleBox">{translate label='Vezi evaluari'}</span></td>
                    </tr>
                        ...
                        {if $key>0}
                            <tr height="30">
                                ...
                                <td class="celulaMenuSTDR"><a class="blue"
                                                              href="./?m=eval&o=forms&PersonID={$item.PersonID}&EvalFormDraftID={$smarty.get.EvalFormDraftID}">{translate label='Vezi lista evaluari '}</a>
                                </td>
                            </tr>
                        {/if}
                        {foreachelse}
                        <tr height="30">
                            <td colspan="100" class="celulaMenuSTDR">{translate label='Nici o persoana evaluata!'}</td>
                        </tr>
                    {/foreach}
                </table>
            </fieldset>
