    ...
    <table width="100%" cellspacing="0" cellpadding="4" class="filter">
        <tr>
            <td align="center"><b>{translate label='Cod Proiect'}</b>&nbsp;<a
                        href="./?m=pontaj&o=reports&report_id=4&ProjectID={$smarty.get.ProjectID}&PersonID={$smarty.get.PersonID}&StartDate={$smarty.get.StartDate|date_format:'%d.%m.%Y'}&EndDate={$smarty.get.EndDate|date_format:'%d.%m.%Y'}&order_by=Code&asc_or_desc=asc"><img
                            src="./images/s_asc.png" border="0"></a>&nbsp;<a
                        href="./?m=pontaj&o=reports&report_id=4&ProjectID={$smarty.get.ProjectID}&PersonID={$smarty.get.PersonID}&StartDate={$smarty.get.StartDate|date_format:'%d.%m.%Y'}&EndDate={$smarty.get.EndDate|date_format:'%d.%m.%Y'}&order_by=Code&asc_or_desc=desc"><img
                            src="./images/s_desc.png" border="0"></a></td>
            <td align="center"><b>{translate label='Faza proiect'}</b>&nbsp;<a
                        href="./?m=pontaj&o=reports&report_id=4&ProjectID={$smarty.get.ProjectID}&PersonID={$smarty.get.PersonID}&StartDate={$smarty.get.StartDate|date_format:'%d.%m.%Y'}&EndDate={$smarty.get.EndDate|date_format:'%d.%m.%Y'}&order_by=Phase&asc_or_desc=asc"><img
                            src="./images/s_asc.png" border="0"></a>&nbsp;<a
                        href="./?m=pontaj&o=reports&report_id=4&ProjectID={$smarty.get.ProjectID}&PersonID={$smarty.get.PersonID}&StartDate={$smarty.get.StartDate|date_format:'%d.%m.%Y'}&EndDate={$smarty.get.EndDate|date_format:'%d.%m.%Y'}&order_by=Phase&asc_or_desc=desc"><img
                            src="./images/s_desc.png" border="0"></a></td>
            <td align="center"><b>{translate label='Faze activitate'}</b></td>
            <td><b>Activitate</b>&nbsp;<a
                        href="./?m=pontaj&o=reports&report_id=4&ProjectID={$smarty.get.ProjectID}&PersonID={$smarty.get.PersonID}&StartDate={$smarty.get.StartDate|date_format:'%d.%m.%Y'}&EndDate={$smarty.get.EndDate|date_format:'%d.%m.%Y'}&order_by=Activity&asc_or_desc=asc"><img
                            src="./images/s_asc.png" border="0"></a>&nbsp;<a
                        href="./?m=pontaj&o=reports&report_id=4&ProjectID={$smarty.get.ProjectID}&PersonID={$smarty.get.PersonID}&StartDate={$smarty.get.StartDate|date_format:'%d.%m.%Y'}&EndDate={$smarty.get.EndDate|date_format:'%d.%m.%Y'}&order_by=Activity&asc_or_desc=desc"><img
                            src="./images/s_desc.png" border="0"></a></td>
            <td align="center"><b>{translate label='Perioada activitate'}</b></td>
            <td align="center"><b>{translate label='Numar total ore'}</b>&nbsp;<a
                        href="./?m=pontaj&o=reports&report_id=4&ProjectID={$smarty.get.ProjectID}&PersonID={$smarty.get.PersonID}&StartDate={$smarty.get.StartDate|date_format:'%d.%m.%Y'}&EndDate={$smarty.get.EndDate|date_format:'%d.%m.%Y'}&order_by=THours&asc_or_desc=asc"><img
                            src="./images/s_asc.png" border="0"></a>&nbsp;<a
                        href="./?m=pontaj&o=reports&report_id=4&ProjectID={$smarty.get.ProjectID}&PersonID={$smarty.get.PersonID}&StartDate={$smarty.get.StartDate|date_format:'%d.%m.%Y'}&EndDate={$smarty.get.EndDate|date_format:'%d.%m.%Y'}&order_by=THours&asc_or_desc=desc"><img
                            src="./images/s_desc.png" border="0"></a></td>
        </tr>
