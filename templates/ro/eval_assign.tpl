<div class="submeniu">
    ...
    {if $smarty.session.USER_ID == 1 || $smarty.session.ACCESSEVAL == 1 || $smarty.session.ACCESSEVAL == 3}
        ...
        <a href="./?m=eval&o=evalAssign" class="selected">{translate label='Asignare evaluare'}</a>
    {/if}
                    ...
                    <table border="0" cellpadding="4" cellspacing="0">
                        <tr>
                            <td style="padding-left: 4px;" width="60">
                                <select id="FunctionID" name="FunctionID" class="cod"
                                        onchange="showInfo('ajax.php?o=personsbyfunction&FunctionID=' + this.value + '&rand=' + parseInt(Math.random()*999999999), 'div_Persons');">
...
<script type="text/javascript">
    showInfo('ajax.php?o=personsbyfunction&FunctionID=' + this.value + '&rand=' + parseInt(Math.random() * 999999999), 'div_Persons');
</script>