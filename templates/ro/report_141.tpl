{if !empty($smarty.get.PersonID)}
    <div style="width:800px; margin:0px;">
        ...
        <p style="text-align:center; margin:0px;">
            ...
            incheiat si inregistrat sub nr. {$info.ContractNo}
        ...
        <p style="text-indent:40px; text-align:justify; margin:0px;">
            ...
            <b>{$info.PersonAddress|default:'......................'}</b>, {if $info.Sex == 'M'}posesor{else}posesoare{/if} a actului de identitate <b><i>CI</i></b>
        ...
        <p style="text-indent:40px; text-align:left; margin:0px;">
            ...
            <span style="text-align:justify;">Capacitatea de a organiza, capacitatea de a conduce, capacitatea de coordonare, capacitatea de control, capacitatea de a
	obtine cele mai bune rezultate, competenta decizionala, capacitatea de a delega, abilitati in gestionarea resurselor umane, 
	capacitatea de a dezvolta abilitatile personalului, abilitati de mediere si negociere, obiectivitate in apreciere.</span>
        </p>
