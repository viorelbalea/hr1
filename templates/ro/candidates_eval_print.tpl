...
<table cellspacing="0" cellpadding="2" width="100%" {if $smarty.get.action=='export_doc'} BORDER="1" {/if}>
    <tr BGCOLOR="#CCCCCC">
        ...
        {if !empty($personalisedlist.Performance)}
            ...
            {/foreach}
        {else}
            <td class="bkdTitleMenu"><span class="TitleBox">Judet</span></td>
            <td class="bkdTitleMenu"><span class="TitleBox">Oras</span></td>
            <td class="bkdTitleMenu"><span class="TitleBox">Email</span></td>
            <td class="bkdTitleMenu"><span class="TitleBox">Dimensiune</span></td>
        {/if}
    </tr>
    {foreach from=$persons key=key item=item name=iter1}
        ...
        {if count($persons)==1}
            <tr height="30">
                <td colspan="100" class="celulaMenuSTDR">Nici o persoana!</td>
            </tr>
        {/if}
    {/foreach}
</table>
