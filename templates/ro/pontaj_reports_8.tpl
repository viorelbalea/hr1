<table width="100%" cellspacing="0" cellpadding="2" class="filter" style="margin-top:6px;">
    ...
    {foreach from=$report key=key item=item}
        ...
        {if !empty($item.Person)}
            ...
            {foreach from=$item.Person item=person}
                <tr>
                    <td class="celulaMenuST">&nbsp;</td>
                    <td class="celulaMenuST">{$person.FullName}</td>
                    <td class="celulaMenuST">{$person.THours}</td>
                    <td class="celulaMenuST">{$person.Cost|default:'-'}</td>
                    <td class="celulaMenuST">&nbsp;</td>
                    <td class="celulaMenuST">&nbsp;</td>
                </tr>
            {/foreach}
