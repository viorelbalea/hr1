                                            ...
                                            {if $rw == 1}
                                                <td>
                                                    <div id="button_mod"><a href="#"
                                                                            onclick="window.location.href = './?m=dictionary&o=performance_dimension&DimensionID={$key}&Dimension=' + escape(document.getElementById('Dimension_{$key}').value) + '&Status=' + (document.getElementById('Status_{$key}').checked ? 1 : 0); return false;"
                                                                            title="{translate label='Modifica dimensiune'}"><b>Mod</b></a></div>
                                                </td>
                                                <td>
                                                    <div id="button_del"><a href="#"
                                                                            onclick="if (confirm('{translate label='Sunteti sigura(a)?'}')) window.location.href = './?m=dictionary&o=performance_dimension&DimensionID={$key}&delDimension=1'; return false;"
                                                                            title="{translate label='Sterge dimensiune'}"><b>Del</b></a></div>
                                                </td>
                                            {/if}
                                        </tr>
                                    {/foreach}
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <div id="button_add"><a href="#"
                                                                        ...
                                                                        title="{translate label='Adauga dimensiune'}"><b>Add</b></a></div>
                                            </td>
                                        </tr>
                                    {/if}
                                </table>
