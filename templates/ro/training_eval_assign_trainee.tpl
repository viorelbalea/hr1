        ...
        <tr>
            <td>
                <fieldset>
                    ...
                    <table border="0" cellpadding="4" cellspacing="0">
                        <tr>
                            <td style="padding-left: 4px;" width="60"><select id="TrainingID" name="TrainingID" class="cod"
                                    ...
                                    {foreach from=$trainings key=key item=item}
                                        <option value="{$item.TrainingID}"
                                                {if $item.trainingid==$form.TrainingID}selected{/if}>{$item.TrainingName}{if $item.FullName} (Trainer: {$item.FullName}){/if}</option>
                                    {/foreach}

                                </select></td>
                            <td>
                                <b>{translate label='Selectati persoana(e)*:'}</b></td>
