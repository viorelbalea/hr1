        ...
        <tr>
            ...
            <td>
                <select id="Type" class="formstyle">
                    <option value="0" selected="selected">{translate label='Planificat'}</option>
                    <option value="1">{translate label='Zi libera'}</option>
                </select>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <select id="CostCenterIDX" class="formstyle">
                    ...
                    {foreach from=$costcenter key=key2 item=item2}
                        <option value="{$key2}" {if $personcost == $key2}selected{/if}>{$item2}</option>
                    {/foreach}
                </select>
            </td>
        </tr>
