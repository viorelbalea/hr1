<div class="submeniu">
    <a href="./?m=surveys&o=forms" class="selected">{translate label='Lista studii'}</a>
    {if $smarty.session.USER_ID == 1 || $smarty.session.ACCESSSURVEY == 1 || $smarty.session.ACCESSSURVEY == 3}
        ...
        <a href="./?m=surveys&o=evalDraft&action=new" class="unselected">{translate label='Adauga formular studiu'}</a>
...
<div class="filter">
    ...
    {if $smarty.get.o=='forms-evaluator'}
            window.location.href = './?m=surveys&o=forms-evaluator&PersonID=' + document.getElementById('PersonID').value + '&StartDate=' + document.getElementById('StartDate').value + '&EndDate=' + document.getElementById('EndDate').value + '&res_per_page=' + document.getElementById('res_per_page').value
    {else}
            window.location.href = './?m=surveys&o=forms&PersonID=' + document.getElementById('PersonID').value + '&StartDate=' + document.getElementById('StartDate').value + '&EndDate=' + document.getElementById('EndDate').value + '&res_per_page=' + document.getElementById('res_per_page').value
    {/if}
            ">
                            ...
                            {foreach from=$item.Evaluated item=c name=iter2}
                                <tr>
                                    <td width="130" class="celulaMenuST"><a
                                                href="./?m=surveys&o=eval&EvalFormID={$c.EvalFormID}" class="blue"><b>deschide</b></a>
                                    </td>
                                    <td width="100"
