...
<form action="{$smarty.server.REQUEST_URI}" method="post">
                            ...
                            <td>
                                <table border="0" cellpadding="4" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="CustomCompany2" value="{$customfields.CustomCompany2|default:''}" maxlength="32">translate label='(camp de tip
                                            text)'}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>{translate label='CustomCompany 3'}:</td>
                                        <td><input type="text" name="CustomCompany3" value="{$customfields.CustomCompany3|default:''}" maxlength="32">translate label='(camp de tip
                                            text)'}
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td>
                                <table border="0" cellpadding="4" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="CustomJob2" value="{$customfields.CustomJob2|default:''}" maxlength="32">{translate label='(camp de tip text)'}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>{translate label='CustomJob 3'}:</td>
                                        <td><input type="text" name="CustomJob3" value="{$customfields.CustomJob3|default:''}" maxlength="32">{translate label='(camp de tip text)'}
                                        </td>
                                    </tr>
                                </table>
                            </td>
                ...
                <fieldset>
                    ...
                    <table border="0" cellpadding="4" cellspacing="0" style="background-color: #F9F9F9;">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="CustomTraining3" value="{$customfields.CustomTraining3|default:''}" maxlength="32">{translate label='(camp de tip text)'}
                            </td>
                        </tr>
                    </table>
            </td>
    ...
    <tr>
        <td colspan="2" valign="top" class="bkdTitleMenu"><font color="#FFFFFF">{translate label='lista de campuri custom care apar in aplicatie'}</td>
    </tr>
    </table>
</form>
