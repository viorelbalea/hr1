...
<table border="0" cellpadding="4" cellspacing="0" class="screen" width="100%">
    <tr>
        <td colspan="2" valign="top" class="bkdTitleMenu"><span class="TitleBox">{translate label='Categorii produse'}</span></td>
    </tr>
    {if $err->getErrors()}
        <tr>
                                        ...
                                        {if $rw == 1}
                                            <td>
                                                <div id="button_mod"><a href="#"
                                                                        onclick="window.location.href = './?m=dictionary&o=product&CatID={$key}&Name=' + escape(document.getElementById('Name_{$key}').value) + '&Descr=' + escape(document.getElementById('Descr_{$key}').value); return false;"
                                                                        title="{translate label='Modifica categoria'}"><b>Mod</b></a></div>
                                            </td>
                                            <td>
                                                <div id="button_del"><a href="#"
                                                                        onclick="if (confirm('{translate label='Sunteti sigura(a) ca vreti sa stergeti aceasta categorie?'}')) window.location.href = './?m=dictionary&o=product&CatID={$key}&delCat=1'; return false;"
                    ...
                    <table border="0" cellpadding="4" cellspacing="0" class="screen">
                        ...
                        {foreach from=$subcats key=key item=item}
                            <tr>
                                ...
                                {if $rw == 1}
                                    <td>
                                        <div id="button_mod"><a href="#"
                                                                onclick="window.location.href = './?m=dictionary&o=product&PCatID={$smarty.get.CatID}&CatID={$key}&Name=' + escape(document.getElementById('Name__{$key}').value) + '&Descr=' + escape(document.getElementById('Descr__{$key}').value); return false;"
                                                                title="{translate label='Modifica subcategoria'}"><b>Mod</b></a></div>
                                    </td>
                                    <td>
                                        <div id="button_del"><a href="#"
                                                                onclick="if (confirm('{translate label='Sunteti sigura(a) ca vreti sa stergeti aceasta subcategorie?'}')) window.location.href = './?m=dictionary&o=product&PCatID={$smarty.get.CatID}&CatID={$key}&delCat=1'; return false;"
                        ...
                        {if $rw == 1}
                            <tr>
                                ...
                                <td colspan="2">
                                    <div id="button_add"><a href="#"
                                                            onclick="window.location.href = './?m=dictionary&o=product&PCatID={$smarty.get.CatID}&CatID=0&Name=' + escape(document.getElementById('Name__0').value) + '&Descr=' + escape(document.getElementById('Descr__0').value); return false;"
    ...
    <tr>
        <td colspan="2" valign="top" class="bkdTitleMenu"><span class="TitleBoxDown">{translate label='categorii & subcategorii produse'}</span></td>
    </tr>
</table>
