<div class="submeniu">
    ...
    {/if}
    {if $smarty.session.USER_ID != 1 || $smarty.session.ACCESSSURVEY == 2 ||  $smarty.session.ACCESSSURVEY == 3}
        <a href="./?m=surveys&o=evalPersons" class="selected">{translate label='Studii personale'}</a>
    {/if}
</div>
<br>
    ...
    <tr>
        ...
        <td style="padding-left: 2px;" width="70">
            <select id="DistrictID" name="DistrictID"
                    onchange="if (this.value>0) window.location.href = './?m=surveys&o=evalPersons&DivisionID=' + document.getElementById('DivisionID').value + '&DistrictID=' + this.value"
                    class="cod">
        ...
        {if !empty($divisions)}
            <td style="padding-left: 2px;" width="75">
                <select id="DivisionID" name="DivisionID"
                        onchange="window.location.href = './?m=surveys&o=evalPersons&DistrictID=' + document.getElementById('DistrictID').value + '&DivisionID=' + this.value"
                        class="dropdown">
    ...
    <tr>
        ...
        <td style="padding-left: 50px;">
            {translate label='Afiseaza doar angajatii'}: <input type="checkbox"
                                                                onclick="if (this.checked) window.location.href = './?m=surveys&o=evalPersons&Status=2'; else window.location.href = './?m=surveys&o=evalPersons';"
        ...
        <td align="right" style="padding-right: 4px;">
            ...
            <input type="button" class="cod" value="Printeaza pagina"
                   onclick="window.location.href='{$smarty.server.REQUEST_URI}&action=print_page'">
            <input type="button" class="cod" value="Printeaza tot"
                   onclick="window.location.href='{$smarty.server.REQUEST_URI}&action=print_all'">
            <input type="button" class="cod" value="{translate label='Personalizare'}"
    ...
    {foreach from=$persons key=key item=item name=iter1}
        {if $key>0}
            <tr height="30">
                ...
                <td class="celulaMenuST"><a href="./?m=surveys&o=forms&PersonID={$item.PersonID}"
