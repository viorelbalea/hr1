                                        ...
                                        {if $rw == 1}
                                            <td>
                                                <div id="button_mod"><a href="#"
                                                                        onclick="window.location.href = './?m=dictionary&o=sites&SiteID={$key}&Site=' + escape(document.getElementById('Site_{$key}').value); return false;"
                                                                        title="{translate label='Modifica locatie'}"><b>Mod</b></a></div>
                                            </td>
                                            <td>
                                                <div id="button_del"><a href="#"
                                                                        onclick="if (confirm('{translate label='Stergerea unei locatii implica stergerea tuturor salilor aferente.\nSunteti sigura(a)?'}')) window.location.href = './?m=dictionary&o=sites&SiteID={$key}&delSite=1'; return false;"
                                                                        title="{translate label='Sterge locatie'}"><b>Del</b></a></div>
                                            </td>
                                        {/if}
                                    </tr>
                                {/foreach}
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <div id="button_add"><a href="#"
                                                                    ...
                                                                    title="{translate label='Adauga locatie'}"><b>Add</b></a></div>
                                        </td>
                                    </tr>
                                {/if}
                            </table>
                        ...
                        <table border="0" cellpadding="4" cellspacing="0" class="screen">
                            ...
                            {foreach from=$rooms key=key item=item}
                                <tr>
                                    ...
                                    {if $rw == 1}
                                        <td>
                                            <div id="button_mod"><a href="#"
                                                                    onclick="window.location.href = './?m=dictionary&o=sites&SiteID={$smarty.get.SiteID}&RoomID={$key}&Room=' + escape(document.getElementById('Room_{$key}').value) + '&Notes=' + escape(document.getElementById('Notes_{$key}').value); return false;"
                                                                    title="{translate label='Modifica sala'}"><b>Mod</b></a></div>
                                        </td>
                                        <td>
                                            <div id="button_del"><a href="#"
                                                                    onclick="if (confirm('{translate label='Sunteti sigura(a)?'}')) window.location.href = './?m=dictionary&o=sites&SiteID={$smarty.get.SiteID}&RoomID={$key}&delRoom={$key}'; return false;"
                                                                    title="{translate label='Sterge sala'}"><b>Del</b></a></div>
                                        </td>
                                    {/if}
                                </tr>
                            {/foreach}
                            {if $rw == 1}
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <div id="button_add"><a href="#"
                                                                onclick="window.location.href = './?m=dictionary&o=sites&SiteID={$smarty.get.SiteID}&RoomID=0&Room=' + escape(document.getElementById('Room_0').value) + '&Notes=' + escape(document.getElementById('Notes_0').value); return false;"
                                                                title="{translate label='Adauga sala'}"><b>Add</b></a></div>
                                    </td>
                                </tr>
                            {/if}
                        </table>
