{if !empty($smarty.get.PersonID)}
    <div style="width:800px; margin:0px;">
        ...
        <p style="text-indent:40px; text-align:justify;">
            ...
            <strong>{$info.PersonAddress|default:'Str. ................ Nr. ...., Bl. ...... Sc. ...., Et. ...., Ap ....., Judet/Sector ..............  '}</strong>,
            {if $info.Sex == 'M'}posesor al{else}posesoare a{/if} CI <strong>seria {$info.BISerie|default:'.........'} nr. {$info.BINumber|default:'....................'}</strong>,
            eliberata de <b>{$info.BIEmitent|default:'.......................'}</b>, la data de <b>{$info.BIStartDate|default:'..................'}</b>,
        ...
        <p>
        <ol>
            <li>Se modifica elementul: <i>** DURATA CONCEDIULUI DE ODIHNA ANUAL </i>al contractului individual de munca se modifica de la ......... zile lucratoare la .........
                zile lucratoare.
            </li>
        </ol>
        </p>
