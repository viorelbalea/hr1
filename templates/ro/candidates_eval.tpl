...
-->
        <tr>
            <td colspan="2" class="celulaMenuSTDR" style="padding: 10px;">
                <fieldset>
                    <legend>Evaluare <b>{if $person.FullName}{$person.FullName}{else}{$PersonExternEmail}{/if}</b> pentru perioada <b>{$StartDate}</b> - <b>{$EndDate}</b></legend>
