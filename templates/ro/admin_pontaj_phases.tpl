                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div id="button_mod"><a href="#"
                                                                        onclick="window.location.href = './?m=admin&o=pontaj_phases&PhaseID={$key}&Phase=' + escape(document.getElementById('Phase_{$key}').value) + '&Notes=' + escape(document.getElementById('Notes_{$key}').value); return false;"
                                                                        title="Modifica faza"><b>{translate label='Mod'}</b></a></div>
                                            </td>
                                            <td>
                                                <div id="button_del"><a href="#"
                                                                        onclick="if (confirm('Sunteti sigura(a)?')) window.location.href = './?m=admin&o=pontaj_phases&PhaseID={$key}&delPhase=1'; return false;"
                                                                        title="Sterge faza"><b>{translate label='Del'}</b></a></div>
                                            </td>
                                        </tr>
                                    {/foreach}
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <div id="button_add"><a href="#"
                                                                    onclick="window.location.href = './?m=admin&o=pontaj_phases&PhaseID=0&Phase=' + escape(document.getElementById('Phase_0').value) + '&Notes=' + escape(document.getElementById('Notes_0').value); return false;"
                                                                    title="Adauga faza"><b>{translate label='Add'}</b></a></div>
                                        </td>
                                    </tr>
                                </table>
                            </td>
