{if !empty($smarty.get.PersonID)}
    <div style="width:800px; margin:0px;">
        ...
        <p>
        <ol>
            <li>Se modifica elementul: <i>** DURATA CONTRACTULUI </i>al contractului individual de munca <b>se prelungeste pe durata nedeterminata</b> din data
                de {if !empty($info.Contract.StartDate)}{$info.Contract.StartDate|date_format:'%d.%m.%Y'}{else}...............................{/if} .
            </li>
        </ol>
        </p>
