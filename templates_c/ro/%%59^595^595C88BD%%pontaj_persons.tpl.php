<?php /* Smarty version 2.6.18, created on 2020-10-07 12:20:07
         compiled from pontaj_persons.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'pontaj_persons.tpl', 3, false),array('function', 'orderby', 'pontaj_persons.tpl', 95, false),array('function', 'math', 'pontaj_persons.tpl', 114, false),array('modifier', 'cat', 'pontaj_persons.tpl', 22, false),array('modifier', 'default', 'pontaj_persons.tpl', 33, false),)), $this); ?>
...
:</label>
    <select id="DistrictID" name="DistrictID"
            onchange="if (this.value>0) window.location.href = './?m=pontaj&DivisionID=' + document.getElementById('DivisionID').value + '&DistrictID=' + this.value" class="cod">
...
" <?php if (((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('cat', true, $_tmp, '_') : smarty_modifier_cat($_tmp, '_')))) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['key2']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['key2'])) == $_GET['Status']): ?>selected<?php endif; ?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->_tpl_vars['item2']; ?>
    ...
    <select id="search_for" nume="search_for" class="cod">
        ...
        <option value="FullName" <?php if ($_GET['search_for'] == 'FullName'): ?>selected<?php endif; ?>><?php echo smarty_function_translate(array('label' => 'Nume si Prenume'), $this);?>
</option>
...
" size="20" maxlength="30" class="cod"
    ...
    <?php if (! empty ( $this->_tpl_vars['divisions'] )): ?>
        <select id="DivisionID" name="DivisionID"
                onchange="window.location.href = './?m=pontaj&DistrictID=' + document.getElementById('DistrictID').value + '&DivisionID=' + this.value" class="dropdown">
...
"
                           onclick="popUp('./?m=settings&o=personalisedlist&list=Pontaj&type=popup','',250,400)">
                </li>
            </ul>
        </div>
    </div>
...
?>
                <td class="bkdTitleMenu">
                    <?php if ($this->_tpl_vars['field'] == 'CostCenterID'): ?>
...
?>
        <?php if ($this->_tpl_vars['key'] > 0): ?>
            <tr height="30">
                ...
                <td class="celulaMenuST"><a href="./?m=pontaj&o=pontaj&PersonID=<?php echo $this->_tpl_vars['item']['PersonID']; ?>
