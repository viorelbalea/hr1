<?php /* Smarty version 2.6.18, created on 2020-10-06 13:01:47
         compiled from pontaj_planificat.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'pontaj_planificat.tpl', 3, false),array('function', 'math', 'pontaj_planificat.tpl', 167, false),array('modifier', 'default', 'pontaj_planificat.tpl', 31, false),array('modifier', 'date_format', 'pontaj_planificat.tpl', 195, false),array('modifier', 'count', 'pontaj_planificat.tpl', 204, false),)), $this); ?>
...
:</label>
    <select id="DistrictID" name="DistrictID" onchange="if (this.value>0) window.location.href = './?m=pontaj&o=pplanif' +
...
" <?php if ($this->_tpl_vars['key'] == $_GET['CompanyID']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['item']; ?>
    ...
    <?php if (! empty ( $this->_tpl_vars['divisions'] )): ?>
        <select id="DivisionID" name="DivisionID" onchange="window.location.href = './?m=pontaj&o=pplanif' +
	                                                                        	'&DistrictID=' + document.getElementById('DistrictID').value + 
	                                                                                '&CityID=' + document.getElementById('CityID').value + 
											'&Status=' + document.getElementById('Status').value + 
											'&CompanyID=' + document.getElementById('CompanyID').value + 
...
" <?php if ($this->_tpl_vars['key'] == $_GET['CostCenterID']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['item']; ?>
    ...
    <input type="text" name="StartDate" id="StartDate" class="formstyle" value="<?php echo $this->_tpl_vars['start_date']; ?>
" size="10" maxlength="10" readonly>
    ...
    <label>si</label>
    <input type="text" name="EndDate" id="EndDate" class="formstyle" value="<?php echo $this->_tpl_vars['end_date']; ?>
" size="10" maxlength="10" readonly>
...
?>
                    <td class="celulaMenuST" style="text-align:center"
                        <?php if ($this->_tpl_vars['wday'] == 'D' || $this->_tpl_vars['wday'] == 'S' || isset ( $this->_tpl_vars['legal'][$this->_tpl_vars['data']] )): ?>bgcolor="#fcde63"<?php else: ?><?php echo smarty_function_math(array('equation' => "x+1",'x' => $this->_tpl_vars['ZL'],'assign' => 'ZL'), $this);?>
<?php endif; ?>>
                        <b><?php echo $this->_foreach['iter']['iteration']; ?>
</b></td>
                <?php endforeach; endif; unset($_from); ?>
                <?php if ($_SESSION['USER_ID'] == 1 || $_SESSION['USER_RIGHTS3']['11']['5']['1'] == 2): ?>
                    <td class="celulaMenuST" style="text-align:center"><input type="submit" name="valid" value="<?php echo smarty_function_translate(array('label' => 'Validare'), $this);?>
"></td>
                <?php endif; ?>
            </tr>
            <tr>
    ...
    foreach ($_from as $this->_tpl_vars['data'] => $this->_tpl_vars['wday']):
?>
                    <td class="celulaMenuST" style="text-align:center" <?php if ($this->_tpl_vars['wday'] == 'D' || $this->_tpl_vars['wday'] == 'S' || isset ( $this->_tpl_vars['legal'][$this->_tpl_vars['data']] )): ?>bgcolor="#fcde63"<?php endif; ?>><b><?php echo $this->_tpl_vars['wday']; ?>
</b></td>
                <?php endforeach; endif; unset($_from); ?>
                <?php if ($_SESSION['USER_ID'] == 1 || $_SESSION['USER_RIGHTS3']['11']['5']['1'] == 2): ?>
                    <td class="celulaMenuST" style="text-align:center"><a href="#" onclick="checkAll(); return false;">check</a> | <a href="#"
...
?>
            ...
            <tr bgcolor="#ffffff">
                <td class="celulaMenuST"><?php echo $this->_foreach['iter']['iteration']-1; ?>
</td>
                <td class="celulaMenuST"><a href="#" onclick="return false; getStat(<?php echo $this->_tpl_vars['persid']; ?>
...
"><?php echo $this->_tpl_vars['item']['FullName']; ?>
    ...
    foreach ($_from as $this->_tpl_vars['data'] => $this->_tpl_vars['wday']):
?>
                    <td class="celulaMenuST" style="text-align:center" <?php if ($this->_tpl_vars['wday'] == 'D' || $this->_tpl_vars['wday'] == 'S' || isset ( $this->_tpl_vars['legal'][$this->_tpl_vars['data']] )): ?>bgcolor="#fcde63"<?php endif; ?>>
...
"><?php echo ((is_array($_tmp=@$this->_tpl_vars['item']['Data'][$this->_tpl_vars['data']])) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0)); ?>
                ...
                <?php endforeach; endif; unset($_from); ?>
                <?php if ($_SESSION['USER_ID'] == 1 || $_SESSION['USER_RIGHTS3']['11']['5']['1'] == 2): ?>
                    <td class="celulaMenuST" style="text-align:center"><input type="checkbox" id="pvalid_<?php echo $this->_tpl_vars['persid']; ?>
...
<?php echo '
    <script type="text/javascript">
        function getAct(persid, data) {
            showInfo(\'./?m=pontaj&o=pplanif_act&PersonID=\' + persid + \'&StartDate=\' + data, \'layer_p_content\');
        ...
        function getStat(persid, start_date, end_date) {
            //showInfo(\'./?m=pontaj&o=pplanif_stat&PersonID=\' + persid + \'&StartDate=\' + start_date + \'&EndDate=\' + end_date, \'layer_s_content\');
...
<script type="text/javascript">
    function filterList() {
        window.location.href = './?m=pontaj&o=pplanif' +
            '&DistrictID=' + document.getElementById('DistrictID').value +
            '&CityID=' + document.getElementById('CityID').value +
            '&Status=' + document.getElementById('Status').value +
            '&CompanyID=' + document.getElementById('CompanyID').value +
