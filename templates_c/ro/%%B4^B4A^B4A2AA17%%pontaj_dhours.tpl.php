<?php /* Smarty version 2.6.18, created on 2020-10-06 13:01:44
         compiled from pontaj_dhours.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'pontaj_dhours.tpl', 11, false),array('modifier', 'default', 'pontaj_dhours.tpl', 38, false),array('modifier', 'date_format', 'pontaj_dhours.tpl', 96, false),array('modifier', 'cat', 'pontaj_dhours.tpl', 194, false),)), $this); ?>
...
:</label>
        <select id="DistrictID" name="DistrictID" onchange="if (this.value>0) window.location.href = './?m=pontaj&o=pdhours' +
...
" <?php if ($this->_tpl_vars['key'] == $_GET['CompanyID']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['item']; ?>
        ...
        <?php if (! empty ( $this->_tpl_vars['divisions'] )): ?>
            <select id="DivisionID" name="DivisionID" onchange="window.location.href = './?m=pontaj&o=pdhours' +
	                                                                        	'&DistrictID=' + document.getElementById('DistrictID').value + 
	                                                                                '&CityID=' + document.getElementById('CityID').value + 
											'&Status=' + document.getElementById('Status').value + 
											'&CompanyID=' + document.getElementById('CompanyID').value + 
...
" <?php if (empty ( $this->_tpl_vars['restrict'][$this->_tpl_vars['hour_val']] ) && $this->_tpl_vars['allow_act'] && empty ( $this->_tpl_vars['restrict_days'][$this->_tpl_vars['dateval']] )): ?>onclick="regClick('<?php echo $this->_tpl_vars['PersonID']; ?>
...
<?php echo '
    <script type="text/javascript">
        ...
        <?php if ($this->_tpl_vars['allow_act']): ?>
        <?php echo '
        var click;
        var styles;
        var texts;
        ...
        function regClick(persid, data, hour, rowid) {
            ...
            if (!click || click[0] != persid || click[1] != data) {
                ...
                showInfo(\'./?m=pontaj&o=pdhours_act&PersonID=\' + persid + \'&StartDate=\' + data + \'&StartHour=\' + click[2] + \'&EndHour=\' + hour + \'&RowID=\' + rowid, \'layer_hp_content\');
...
<script type="text/javascript">
    function filterList() {
        window.location.href = './?m=pontaj&o=pdhours' +
            '&DistrictID=' + document.getElementById('DistrictID').value +
            '&CityID=' + document.getElementById('CityID').value +
            '&Status=' + document.getElementById('Status').value +
            '&CompanyID=' + document.getElementById('CompanyID').value +
