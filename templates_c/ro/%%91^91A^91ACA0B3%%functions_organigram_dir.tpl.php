<?php /* Smarty version 2.6.18, created on 2020-09-21 08:33:50
         compiled from functions_organigram_dir.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'functions_organigram_dir.tpl', 12, false),array('function', 'recurse_array', 'functions_organigram_dir.tpl', 45, false),array('function', 'recurse_array_horiz', 'functions_organigram_dir.tpl', 68, false),array('function', 'recurse_array_vert', 'functions_organigram_dir.tpl', 77, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?><br/>
    <div style="float:left">
        <fieldset>
            <legend><?php echo smarty_function_translate(array('label' => 'Organigrama directii si servicii'), $this);?>
</legend>
...
:</td>
                    <td style="padding-left: 2px;" width="70"><select id="CompanyID" name="CompanyID" class="dropdown" style="width:120px;"
                                                                      onchange="window.location.href = './?m=functions&o=organigram_dir&CompanyID=' + document.getElementById('CompanyID').value + '&Level=' + document.getElementById('Level').value">
...
:</td>
                    <td style="padding-left: 2px;" width="70"><select id="Level" name="Level" class="dropdown" style="width:120px;"
                                                                      onchange="window.location.href = './?m=functions&o=organigram_dir&CompanyID=' + document.getElementById('CompanyID').value + '&mark=<?php echo $_GET['mark']; ?>
...
<div style="float:left; width:50%;">
    <fieldset>
        <legend><?php echo smarty_function_translate(array('label' => 'Organigrama'), $this);?>
</legend>
        <a id="showHorizontal" class="selected" href="#"><?php echo smarty_function_translate(array('label' => 'Organigrama orizontala'), $this);?>
</a>
        [<a href="?m=functions&o=organigram_dir&CompanyID=<?php echo $_GET['CompanyID']; ?>
