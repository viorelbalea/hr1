<?php /* Smarty version 2.6.18, created on 2020-10-06 05:30:11
         compiled from dictionary_library.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'dictionary_library.tpl', 4, false),)), $this); ?>
...
<table border="0" cellpadding="4" cellspacing="0" class="screen" width="100%">
    <tr>
        <td colspan="2" valign="top" class="bkdTitleMenu"><span class="TitleBox"><?php echo smarty_function_translate(array('label' => 'Biblioteca'), $this);?>
</span></td>
    </tr>
                                        ...
                                        <?php if ($this->_tpl_vars['rw'] == 1): ?>
                                            <td>
                                                <div id="button_mod"><a href="#"
                                                                        onclick="window.location.href = './?m=dictionary&o=library&CatID=<?php echo $this->_tpl_vars['key']; ?>
...
')) window.location.href = './?m=dictionary&o=library&CatID=<?php echo $this->_tpl_vars['key']; ?>
...
" size="30" maxlength="255"></td>
                                <?php if ($this->_tpl_vars['rw'] == 1): ?>
                                    <td>
                                        <div id="button_mod"><a href="#"
                                                                onclick="window.location.href = './?m=dictionary&o=library&PCatID=<?php echo $_GET['CatID']; ?>
...
')) window.location.href = './?m=dictionary&o=library&PCatID=<?php echo $_GET['CatID']; ?>
&CatID=<?php echo $this->_tpl_vars['key']; ?>
&delCat=1'; return false;"
...
"><b>Add</b></a></div>
    ...
    <tr>
        <td colspan="2" valign="top" class="bkdTitleMenu"><span class="TitleBoxDown"><?php echo smarty_function_translate(array('label' => 'categorii & subcategorii'), $this);?>
</span></td>
    </tr>
</table>