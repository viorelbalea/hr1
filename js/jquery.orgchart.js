...
(function ($) {
    ...
    $.fn.orgChart = function (options, $appendTo) {
        ...
        return this.each(function () {
            ...
            if ($this.is("ul")) {
                ...
                else if ($this.find("ul:first").children("li").length > 1) {
            ...
            $appendTo.append("<h2>" + opts.treeTitle + "</h2>");
    ...
    function buildNode($node, $appendTo, level, opts) {
        var $table = $("<table class='tableOrg' cellpadding='0' cellspacing='0' border='0'/>");
        var $tbody = $("<tbody/>");
        // Make this node...
        ...
        if ($childNodes.hasClass('free'))
            $nodeDiv = $("<div>").addClass("node").addClass("free").append($heading);
        else
